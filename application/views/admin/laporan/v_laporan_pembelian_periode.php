...
<head>
    <title>Laporan Pembelian Kain Periode</title>
    <meta charset="utf-8">
...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4>LAPORAN PEMBELIAN KAIN</h4></center><br/></td>
</tr>                     
...
<table border="1" align="center" style="width:900px;margin-bottom:20px;">
	<thead>
		<tr>
		<th colspan="11" style="text-align:left;">Laporan Pembelian Kain</th>
		</tr>
	...
	<tbody>
        <?php $total=0;$no=0; foreach ($record->result_array() as $i){
