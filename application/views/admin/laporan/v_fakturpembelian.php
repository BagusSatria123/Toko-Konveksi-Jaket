...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4>DAFTAR PEMBELIAN BAHAN BAKU</h4></center><br/></td>
</tr> 
<?php 
    $b = $data ;
?>
<table border="0" align="center" style="width:700px;border:none;margin-bottom:10px;">
        <tr>
            <th style="text-align:left;width:130;">Kode Pembelian</th>
            <th style="text-align:left;">: <?php echo $b['beli_kode'];?></th>
        ...
        <tr>
            <th style="text-align:left;">Tanggal Beli</th>
...
<thead>
    ...
    <tr>
        ...
        <th>Nama Bahan Baku yang Dibeli</th>
        <th>Warna</th>
		<th>Satuan</th>
...
<?php 
$no=0;
    foreach ($data_item->result_array() as $i) {
        $no++;
